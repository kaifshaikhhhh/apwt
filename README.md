...
1. Make sure you have ruby-dev, bundler, and nodejs installed
    ...
    ```
  On macOS the recommended steps are:
  ```bash
  ...
  gem install bundler
  ```
1. Run `bundle config set --local path 'vendor/bundle'` then `bundle install` to install Ruby dependencies locally. If you get errors, delete Gemfile.lock and try again.
